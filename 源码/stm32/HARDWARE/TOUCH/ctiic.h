...
//IO方向设置
#define CT_SDA_IN()  {GPIOB->MODER&=~((uint32_t)3<<(2*15));GPIOB->MODER|=(uint32_t)0<<2*15;}	//PB15输入模式
#define CT_SDA_OUT() {GPIOB->MODER&=~((uint32_t)3<<(2*15));GPIOB->MODER|=(uint32_t)1<<2*15;} 	//PB15输出模式
//IO操作函数	 

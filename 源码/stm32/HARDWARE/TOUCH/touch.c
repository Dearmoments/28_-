...
u8 TP_Init(void)
{
  GPIO_InitTypeDef  GPIO_InitStructure;	
    ...
    //GPIOB1,2初始化设置
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13 | GPIO_Pin_14;//PB13/PB14 设置为上拉输入T_PEN,T_MISO
    ...
    GPIO_Init(GPIOB, &GPIO_InitStructure);//初始化
		...
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12;//PB12设置为推挽输出CLK
		GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//输出模式
	  GPIO_Init(GPIOB, &GPIO_InitStructure);//初始化
		
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_11;//PF11设置为推挽输出T_CS
		GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//输出模式
	  GPIO_Init(GPIOF, &GPIO_InitStructure);//初始化	
		
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_15;//PB15设置推挽输出T_MOSI
		GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//输出模式
	  GPIO_Init(GPIOB, &GPIO_InitStructure);//初始化			
